<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="TestTask.WebForm2" %>
...
<body>
    ...
    ***********************************-->
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    ...
                    <div class="col p-md-0">
                        ...
                        <a href="index-blog.html">Blog</a></div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="d-flex justify-content-end my-4 invoice-save-btns">
                                            <asp:Button ID="Button1" OnClick="SaveBtn_Click1" runat ="server" CssClass="auto-style1" Text="Save" class="btn btn-primary btn-sl-lg mr-3"/>
                                ...
                                <div class="row">
                                    <div class="col-lg-5">
                                        ...
                                        <div class="form-group my-4">
                                            <asp:TextBox runat="server" ID="TextBox1" cols="30" placeholder="Add Description" rows="5" class="form-control pt-3 pl-4 bg-white"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                ...
                                <div class="row border-bottom">
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            <label class="text-dark" for="invoiceinput">Invoice No.</label>
                                            <asp:TextBox runat="server" class="form-control bg-transparent" ID="TextBox2" placeholder="No."></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-lg-9">
                                ...
                                <div class="row my-4">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Name], [Id] FROM [Clients]"></asp:SqlDataSource>
                                            <asp:DropDownList ID="DropDownList1" runat="server" class="selectpicker" data-style="text-muted" DataSourceID="SqlDataSource2" DataTextField="Name" DataValueField="Id">
                                            </asp:DropDownList>
                                            <!-- <div class="drop-menu border" tabindex="1">
                                                <div class="select"><span>Select Customer</span>  <i class="fa fa-caret-down"></i>
                                                </div>
                                            ...
                                            <table class="table invoice-details-table" style="min-width: 620px;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="muted-text">$ <span>
                                                            <input runat="server" type="number" id="Number1" />
                                                                                 </span>
                                                        </td>
                                                        <td class="muted-text">
                                                            <input runat="server" class="border-0" value="01" type="number" name="inputdesc" id="Number2"/>
                                                        </td>
                                                        <td class="muted-text">
                                                    ...
                                                    <tr>
                                                        <td colspan="4" class="border-0">
                                                            <div class="d-flex invoice-upload">
                                                                <div class="add-line">
                                                                    <i class="fa fa-plus"></i>Add Line
                                                                </div>
                                                                <div class="attach-pdf ml-5">
                                                                    <i class="fa fa-paperclip" aria-hidden="true"></i>
                                                                    <label for="attachpdf">Attach Image</label>
                                                                    <asp:Image type="file" name="inputimage" id="attachpdf" class="d-none" />
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="border-0"></td>
                                                        <td class="border-0"></td>
                                                        <td class="border-0">VAT</td>
                                                        <td class="text-primary border-0">$ <span>0.000</span> %</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="border-0"></td>
                                                        <td class="border-0"></td>
                                                        <td class="border-0"></td>
                                                        <td class="text-primary border-bottom">Total Excluding VAT</td>
                                                        <td class="text-primary border-bottom">$ <span>0.000</span> %</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand = "SELECT [Description] , [Invoice_NO] , [Client_id] , [Date] , [invoice_items] , [total_before_tax] , [total_vat] , [total_after_vat] FROM [Invoices]">
    ...
    ***********************************-->
    ...
    <script src="js/styleSwitcher.js"></script>
                                    ...
                                    <div class="col-lg-6">
                                        <h6>Select Customer</h6>
                                        <div class="form-group">
                                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Name], [Id] FROM [Clients]"></asp:SqlDataSource>
                                            <asp:DropDownList ID="TextBox3" runat="server" class="selectpicker" data-style="text-muted" DataSourceID="SqlDataSource2" DataTextField="Name" DataValueField="Id">
                                            </asp:DropDownList>
                                            <asp:Calendar ID="TextBox4" runat="server"></asp:Calendar>
                                            <td class="muted-text">
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="CreateInvoice" SelectCommandType="StoredProcedure">
            <SelectParameters>
