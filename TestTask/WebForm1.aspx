<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="invoices.aspx.cs" Inherits="Invoices.WebForm1" %>
...
<body>
        ...
        ***********************************-->
        <div class="content-body">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6 col-lg-3 mb-4 text-center mb-lg-0">
                                        <div class="circle-progress mt-4">
                                            <div class="circle-wrapper">
                                                <div id="invoice-circle-1"></div>
                                                <div class="absolute-icons">
                                                    <img src="../../assets/images/icons/20.png" alt="">
                                                    <h6 class="mt-2">20 Invoice</h6>
                                                </div>
                                            </div>
                                            ...
                                            <div class="bottom-text mt-2">
                                                <h6>Total Invoice</h6>
                                                <h4 class="text-info  mt-4">$<span>13250</span></h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-lg-3 mb-4 text-center mb-lg-0">
                                        <div class="circle-progress mt-4">
                                            <div class="circle-wrapper">
                                                <div id="invoice-circle-2"></div>
                                                <div class="absolute-icons">
                                                    <img src="../../assets/images/icons/21.png" alt="">
                                                    <h6 class="mt-2">06 Invoice</h6>
                                                </div>
                                            </div>
                                            <div class="bottom-text mt-2">
                                                <h6>Overrude</h6>
                                                <h4 class="text-danger  mt-4">$<span>4250</span></h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-lg-3 mb-4 text-center mb-lg-0">
                                        <div class="circle-progress mt-4">
                                            <div class="circle-wrapper">
                                                <div id="invoice-circle-3"></div>
                                                <div class="absolute-icons">
                                                    <img src="../../assets/images/icons/22.png" alt="">
                                                    <h6 class="mt-2">08 Invoice</h6>
                                                </div>
                                            </div>
                                            <div class="bottom-text mt-2">
                                                <h6>Paid</h6>
                                                <h4 class="text-warning  mt-4">$<span>3000</span></h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-lg-3 mb-4 text-center mb-lg-0">
                                        <div class="circle-progress mt-4">
                                            <div class="circle-wrapper">
                                                <div id="invoice-circle-4"></div>
                                                <div class="absolute-icons">
                                                    <img src="../../assets/images/icons/23.png" alt="">
                                                    <h6 class="mt-2">06 Invoice</h6>
                                                </div>
                                            </div>
                                            <div class="bottom-text mt-2">
                                                <h6>Unpaid</h6>
                                                <h4 class="text-success  mt-4">$<span>6000</span></h4>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h4 class="heading-primary mb-4">Invoice List</h4>
                        <div class="card transparent-card invoice-list-header">
                            <div class="d-sm-flex justify-content-between">
                                <div class="invoice-list-header-left mb-4 mb-sm-0">
                                    <button class="btn btn-light mr-3" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                    </button>
                                    
                                    <button class="btn btn-light mr-3" title="download"><i class="fa fa-download" aria-hidden="true"></i>
                                    </button>
                                    <button class="btn btn-light mr-3" title="print"><i class="fa fa-print" aria-hidden="true"></i>
                                    </button>
                                    <button class="btn btn-light" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i>
                                    </button>
                                </div>
                                <div class="invoice-list-header-right d-flex">
                                    
                                    
                                    <button class="btn btn-primary" title="Add new invoice"><i class="fa fa-plus" aria-hidden="true"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="d-sm-flex justify-content-between align-items-center">
                            <div class="meta-left table-meta-item">
                                <p class="mb-0 text-dark">Latest Tickets (Showing 01 to 06 of 45 Tickets)</p>
                            </div>
                            <div class="meta-right">
                                <div class="stat-widget-search-2">
                                        <div class="form-group mb-0">
                                            <input type="search" name="filter" placeholder="Type to filter tickets.." id="filter" class="form-control pl-0 pr-5">
                    ...
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Invoice_NO" DataSourceID="SqlDataSource2">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="total_vat" HeaderText="total_vat" SortExpression="total_vat" />
                                    <asp:BoundField DataField="total_after_vat" HeaderText="total_after_vat" SortExpression="total_after_vat" />
                                </Columns>
                            </asp:GridView>
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Invoice_NO], [Date], [Client_id], [total_vat], [total_after_vat] FROM [Invoices]"></asp:SqlDataSource>
                            <table class="table table-padded verticle-middle invoice-list-table table-trans" style="min-width: 700px;">
                                <tbody>
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="basic_checkbox_0" id="basic_checkbox_0">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Invoice_NO], [Date], [Client_id], [total_vat], [total_after_vat] FROM [Invoices]"></asp:SqlDataSource>
                                    <tr>
                                        <td>
                                        ...
                                        <td>[Invoice_NO]</td>
                                        <td><span class="text-muted">08 Mar, 2018</span>
                                        </td>

                                        <td>Y&Co Distributors</td>
                                        <td>$ <span>3.84</span>
                                        </td>
                                        <td><span class="text-primary"><span>$ </span>1 520.00</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="basic_checkbox_2" id="basic_checkbox_2">
                                            <label for="basic_checkbox_2"></label>
                                        </td>
                                        <td>154 - 24</td>
                                        <td><span class="text-muted">10 Mar, 2018</span>
                                        </td>

                                        <td>Graphic Design</td>
                                        <td>$ <span>5.84</span>
                                        </td>
                                        <td><span class="text-primary"><span>$ </span>1 320.00</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="basic_checkbox_3" id="basic_checkbox_3">
                                    ...
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="basic_checkbox_4" id="basic_checkbox_4">
                        ...
                        <div class="table-pagination mb-5">
                            <ul class="pagination pagination-md pagination-rounded justify-content-md-end">
                                <li class="page-item"><a class="page-link" href="javascript:void()">01</a>
                                </li>
                                <li class="page-item"><a class="page-link" href="javascript:void()">02</a>
                                </li>
                                <li class="page-item active"><a class="page-link" href="javascript:void()">03</a>
                                </li>
                                <li class="page-item"><a class="page-link" href="javascript:void()">04</a>
                                </li>
                                <li class="page-item"><a class="page-link" href="javascript:void()">05</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="admin-settings">
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    &nbsp;<span><input type="radio" name="navigation_header" value="color_2" class="filled-in chk-col-primary" id="nav_header_bg_2">
                                        <label for="nav_header_bg_2"></label>
                                    </span>
                                    &nbsp;<span><input type="radio" name="navigation_header" value="color_3" class="filled-in chk-col-primary" id="nav_header_bg_3">
                                        <label for="nav_header_bg_3"></label>
                                    </span>
                                    &nbsp;<span><input type="radio" name="navigation_header" value="color_4" class="filled-in chk-col-primary" id="nav_header_bg_4">
                                        <label for="nav_header_bg_4"></label>
                                    </span>
                                    &nbsp;<span><input type="radio" name="navigation_header" value="color_5" class="filled-in chk-col-primary" id="nav_header_bg_5">
                                        <label for="nav_header_bg_5"></label>
                                    </span>
                                    &nbsp;<span><input type="radio" name="navigation_header" value="color_6" class="filled-in chk-col-primary" id="nav_header_bg_6">
                                        <label for="nav_header_bg_6"></label>
                                    </span>
                                    &nbsp;<span><input type="radio" name="navigation_header" value="color_7" class="filled-in chk-col-primary" id="nav_header_bg_7">
                                        <label for="nav_header_bg_7"></label>
                                    </span>
                                    &nbsp;<span><input type="radio" name="navigation_header" value="color_8" class="filled-in chk-col-primary" id="nav_header_bg_8">
                                        <label for="nav_header_bg_8"></label>
                                    </span>
                                    &nbsp;<span><input type="radio" name="navigation_header" value="color_9" class="filled-in chk-col-primary" id="nav_header_bg_9">
                                        <label for="nav_header_bg_9"></label>
                                    </span>
                                    &nbsp;<span><input type="radio" name="navigation_header" value="color_10" class="filled-in chk-col-primary" id="nav_header_bg_10">
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    &nbsp;<span><input type="radio" name="header_bg" value="color_2" class="filled-in chk-col-primary" id="header_bg_2">
                                        <label for="header_bg_2"></label>
                                    </span>
                                    &nbsp;<span><input type="radio" name="header_bg" value="color_3" class="filled-in chk-col-primary" id="header_bg_3">
                                        <label for="header_bg_3"></label>
                                    </span>
                                    &nbsp;<span><input type="radio" name="header_bg" value="color_4" class="filled-in chk-col-primary" id="header_bg_4">
                                        <label for="header_bg_4"></label>
                                    </span>
                                    &nbsp;<span><input type="radio" name="header_bg" value="color_5" class="filled-in chk-col-primary" id="header_bg_5">
                                        <label for="header_bg_5"></label>
                                    </span>
                                    &nbsp;<span><input type="radio" name="header_bg" value="color_6" class="filled-in chk-col-primary" id="header_bg_6">
                                        <label for="header_bg_6"></label>
                                    </span>
                                    &nbsp;<span><input type="radio" name="header_bg" value="color_7" class="filled-in chk-col-primary" id="header_bg_7">
                                        <label for="header_bg_7"></label>
                                    </span>
                                    &nbsp;<span><input type="radio" name="header_bg" value="color_8" class="filled-in chk-col-primary" id="header_bg_8">
                                        <label for="header_bg_8"></label>
                                    </span>
                                    &nbsp;<span><input type="radio" name="header_bg" value="color_9" class="filled-in chk-col-primary" id="header_bg_9">
                                        <label for="header_bg_9"></label>
                                    </span>
                                    &nbsp;<span><input type="radio" name="header_bg" value="color_10" class="filled-in chk-col-primary" id="header_bg_10">
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    &nbsp;<span><input type="radio" name="sidebar_bg" value="color_2" class="filled-in chk-col-primary" id="sidebar_bg_2">
                                        <label for="sidebar_bg_2"></label>
                                    </span>
                                    &nbsp;<span><input type="radio" name="sidebar_bg" value="color_3" class="filled-in chk-col-primary" id="sidebar_bg_3">
                                        <label for="sidebar_bg_3"></label>
                                    </span>
                                    &nbsp;<span><input type="radio" name="sidebar_bg" value="color_4" class="filled-in chk-col-primary" id="sidebar_bg_4">
                                        <label for="sidebar_bg_4"></label>
                                    </span>
                                    &nbsp;<span><input type="radio" name="sidebar_bg" value="color_5" class="filled-in chk-col-primary" id="sidebar_bg_5">
                                        <label for="sidebar_bg_5"></label>
                                    </span>
                                    &nbsp;<span><input type="radio" name="sidebar_bg" value="color_6" class="filled-in chk-col-primary" id="sidebar_bg_6">
                                        <label for="sidebar_bg_6"></label>
                                    </span>
                                    &nbsp;<span><input type="radio" name="sidebar_bg" value="color_7" class="filled-in chk-col-primary" id="sidebar_bg_7">
                                        <label for="sidebar_bg_7"></label>
                                    </span>
                                    &nbsp;<span><input type="radio" name="sidebar_bg" value="color_8" class="filled-in chk-col-primary" id="sidebar_bg_8">
                                        <label for="sidebar_bg_8"></label>
                                    </span>
                                    &nbsp;<span><input type="radio" name="sidebar_bg" value="color_9" class="filled-in chk-col-primary" id="sidebar_bg_9">
                                        <label for="sidebar_bg_9"></label>
                                    </span>
                                    &nbsp;<span><input type="radio" name="sidebar_bg" value="color_10" class="filled-in chk-col-primary" id="sidebar_bg_10">
    ...
    ***********************************-->
    ...
    <script src="js/plugins-init/circle-invoice-init.js"></script>
</body>
</html>
